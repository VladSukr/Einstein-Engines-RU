...
/// <summary>
/// Серверная система социализации чата: мягкая/агрессивная очистка и интеграция антиспама.
/// </summary>
public sealed partial class ChatSanitizationSystem : EntitySystem
{
    ...
    /// <summary>
    /// Регулярка для ссылок, срабатывает на любой домен.
    /// </summary>
    private static readonly Regex UrlRegex =
        new("[-a-zA-Z0-9@:%._\\+~#=]{1,256}\\.[a-zA-Z0-9()]{1,6}\\b([-a-zA-Z0-9()@:%_\\+.~#?&\\/\\/=]*)", RegexOptions.Compiled);

    /// <summary>
    /// Регулярка для ASCII-арта: запрещает символы вне базового диапазона.
    /// </summary>
