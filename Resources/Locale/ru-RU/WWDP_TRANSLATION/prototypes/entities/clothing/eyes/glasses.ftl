...
ent-ClothingEyesGlassesSunglasses = солнцезащитные очки
    .desc = Подходят как для ДШ, так и для карго.
    .suffix = { "" }

ent-ClothingEyesGlassesSecurity = солнцезащитные очки охраны
    .desc = Странная древняя технология помогает обеспечить простейшую защиту глаз. Улучшенное покрытие блокирует различные вспышки. Часто носятся бюджетниками Департамента Шерифа.
    .suffix = { "" }
