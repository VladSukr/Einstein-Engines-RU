...
ui-vote-restart-fail-not-enough-ghost-players = Голосование за перезапуск не удалось: для начала голосования требуется минимум { $ghostPlayerRequirement }% игроков-призраков. В настоящее время игроков-призраков недостаточно.
