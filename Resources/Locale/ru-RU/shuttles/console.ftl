shuttle-pilot-start = Вы управляете кораблём
shuttle-pilot-end = Вы перестали управлять кораблём

shuttle-console-in-ftl = Нельзя: корабль уже в БСС
shuttle-console-mass = Масса слишком велика для БСС
shuttle-console-gravity-blocked = Привод БСС заблокирован активным генератором гравитации
...
shuttle-console-dock-toggle = Показать стыковки
...
shuttle-console-view = Просмотр
shuttle-console-undock = Отстыковать
shuttle-console-dock = Стыковать
shuttle-console-docks-label = Стыковки
