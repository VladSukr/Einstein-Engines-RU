...
alert-level-red-announcement = На станции присутствует известная угроза. Департамента Шерифа имеет право применять летальную силу по необходимости. Члены экипажа должны укрыться в безопасном месте, и следовать указаниям, отдаваемым действующей властью.
...
alert-level-white-announcement = На станции зафиксированы опасно высокие уровни глиммера, присутствуют несколько активных псионных угроз или иная значительная эпистемическая чрезвычайная ситуация. Отключите все глиммер-зонды. Найдите псионную изоляцию. Псионикам следует явиться для процедуры слома разума.
alert-level-white-instructions = Членам экипажа рекомендуется найти псионную изоляцию. Псионикам следует явиться для процедуры слома разума или големизации.
...
alert-level-gamma-announcement = Центральное командование объявило на станции уровень угрозы "Гамма". Департамент Шерифа должен постоянно иметь при себе оружие, гражданский персонал обязан немедленно обратиться к главам отделов для получения указаний к эвакуации.
