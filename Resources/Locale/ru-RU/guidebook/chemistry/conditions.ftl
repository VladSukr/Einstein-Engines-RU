...
reagent-effect-condition-guidebook-total-hunger =
    { $max ->
        [2147483648] общий уровень голода цели составляет не менее {NATURALFIXED($min, 2)}
        *[other] { $min ->
                    [0] общий уровень голода цели составляет не более {NATURALFIXED($max, 2)}
                    *[other] общий уровень голода цели составляет от {NATURALFIXED($min, 2)} до {NATURALFIXED($max, 2)}
                 }
    }
