...
particle-accelerator-control-menu-alarm-control-2 = [bold][color=red]ОТКАЗ ОГРАНИЧИТЕЛЯ[/bold][/color]
particle-accelerator-control-menu-scan-parts-button = Сканировать части
particle-accelerator-control-menu-check-containment-field-warning = Перед запуском убедитесь, что защитное поле активно
particle-accelerator-control-menu-foo-bar-baz = FOO-BAR-BAZ
particle-accelerator-control-menu-status-label = Статус: { $status }
particle-accelerator-control-menu-status-unknown = [font="Monospace"][color=red]Неизвестно[/color][/bold]
...
particle-accelerator-radio-message-on = Питание УЧ включено.
particle-accelerator-radio-message-off = Питание УЧ отключено.
