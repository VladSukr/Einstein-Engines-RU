...
job-description-brigmedic = Сражайтесь в тылу Департамента Шерифа, за жизни своих товарищей! Вы - первая и последняя надежда своей команды. Да благословит вас Гиппократ.
...
job-description-chef = Кормите экипаж стианции разными блюдами, разделывайте мёртвых животных так, чтобы не просачивалась аммиак, и помогайте поддерживать бар в оживлённом состоянии.
...
job-description-clown = Развлекай экипаж с помощью нелепых трюков или ужасных шуток.
job-description-cmo = Управляй ресурсами и персоналом медицинского отдела, чтобы экипаж оставался жив.
