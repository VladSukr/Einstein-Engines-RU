...
zombieteors-description = Нежить ворвалась на станцию ​​из-за катастрофического метеоритного дождя! Работайте вместе с другими членами экипажа и сделайте всё возможное, чтобы выжить!
