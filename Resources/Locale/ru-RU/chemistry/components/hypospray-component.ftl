...
hypospray-verb-mode-label = Переключить забор из контейнера
hypospray-verb-mode-inject-all = Вы больше не можете забирать из контейнеров.
hypospray-verb-mode-inject-mobs-only = Теперь вы можете забирать из контейнеров.
